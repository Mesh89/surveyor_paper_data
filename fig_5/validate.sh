...
minimap2 -t $THREADS -ax map-pb -I 48G ~/references/GRCh38_full_analysis_set_plus_decoy_hla.fa $WORKDIR/relevant_reads.fq.gz | samtools view -b > $WORKDIR/relevant_reads.FULL-REF.bam
